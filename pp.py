...
bot = telebot.TeleBot('7627011302:AAGUWl159H3CfP8po5CbUm5AnQy1mCCAxuc')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Yᴏᴜ Hᴀᴠᴇ Nᴏᴛ Pᴜʀᴄʜᴀsᴇᴅ Yᴇᴛ Pᴜʀᴄʜᴀsᴇ Nᴏᴡ:- @LASTWISHES0."
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @LASTWISHES0 🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Fʀᴇᴇ Kᴇ Dʜᴀʀᴍ Sʜᴀʟᴀ Hᴀɪ Yᴀ Jᴏ Mᴜ Uᴛᴛʜᴀ Kᴀɪ Kʜɪ Bʜɪ Gᴜꜱ Rʜᴀɪ Hᴏ Bᴜʏ Kʀᴏ Fʀᴇᴇ Mᴀɪ Kᴜᴄʜ Nʜɪ Mɪʟᴛᴀ Bᴜʏ:- @LASTWISHES0 🙇."
    bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @LASTWISHES0"
    bot.reply_to(message, response)
